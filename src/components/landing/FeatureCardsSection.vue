...
const featureCards = [
  {
    ...
    description: 'Access expert-led professional programmes in law, finance, governance and tax, earn certificates, and track your progress on our world-class learning platform — tailored for African professionals.',
  ...
  },
  {
    ...
    description: 'Explore openings posted directly by Formation Exceptionelle. Apply with ease and track your applications in real time.',
    ...
    path: '/jobs',
    features: [
      'Full-time, part-time & remote roles',
      'Internship programs',
      'Application tracking',
      'Apply directly to our team',
    ],
    cta: 'View Openings',
    stat: 'New Roles Weekly',
    featured: false,
    authTitle: 'Explore Our Openings',
    authDescription: 'Sign in to browse and apply for roles posted by Formation Exceptionelle.',
  },
  {
    id: 'instructor',
