    ...
    <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-6">
      ...
      <div class="flex flex-col sm:flex-row gap-2">
        <div class="relative">
          ...
          <input v-model="search" type="text" placeholder="Search users..." class="w-full sm:w-auto pl-9 pr-4 py-2.5 rounded-xl border border-gray-200 text-sm focus:outline-none focus:ring-2 focus:ring-purple-400" />
        </div>
        <select v-model="roleFilter" class="w-full sm:w-auto px-3 py-2.5 rounded-xl border border-gray-200 text-sm focus:outline-none focus:ring-2 focus:ring-purple-400">
